# Copytrading bot on Raydium and Pumpfun
...
### Supoprt
It is not displaying the basic functions so when any dev needs a full codebase, feel free to leave issue or you can contact me here: [X](https://c.om/0xmooncity) as well.
